...
public interface UserImpl {
	@Insert("INSERT INTO t_login_user (user_id, password,user_name,mail_address,gender_type, delete_flg) VALUES (#{user_id}, #{password},#{user_name},#{mail_address},#{gender_type}, false)")
	void registUser(@Param("user_id") String user_Id,@Param("password")String password, @Param("user_name")String user_name,@Param("mail_address")String mail_address,@Param("gender_type")String gender_type);
